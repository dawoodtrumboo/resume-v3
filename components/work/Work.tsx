            ...
            <div className="content">
              <h1
                ...
                dangerouslySetInnerHTML={{
                  __html: `<strong>Crowdfunding Platform</strong> Web App`,
                }}
              ></h1>
              <p
                style={{
              ...
              >
              Worked on Crowdfunding Platform application as my final year project, 
              created frontend for the app, took a part in designing the architecture of the backend. 
              Mainly used React and Tailwind CSS.
              </p>
              <div className="box">
                <a href="https://crowdfundingplatformonblockchain.vercel.app/">
                  {" "}
                  <button>
                    <span>Website </span>
                  </button>
          ...
          <section className="panel orange" ref={(e) => createPanelsRefs(e, 2)}>
            <div className="content">
              <h1
                ...
                dangerouslySetInnerHTML={{
                  __html: `<strong>Online Medical Store</strong>`,
                }}
              ></h1>
              <p
                style={{
              ...
              >
                Worked on online medical store website, created bunch of pages and components 
                with the care of responsive design. Mainly used HTML CSS and Javascript along 
                with Bootstrap.
              </p>
              <div className="box">
                <a href="https://github.com/dawoodtrumboo/Online-Medical-Store">
                  <button
          ...
          <section className="panel green" ref={(e) => createPanelsRefs(e, 3)}>
            <div className="content">
              <h1
                ...
                dangerouslySetInnerHTML={{
                  __html: `<strong>Notion </strong> Clone`,
                }}
              ></h1>
              <p
                style={{
              ...
              <div className="box">
                <a href="https://notion-homepage-clone.vercel.app/">
                  <button
